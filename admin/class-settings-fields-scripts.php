...
class Settings_Fields_Scripts {
	...
	public function settings() {
		 ...
		 */
		add_settings_section( 'ccp-scripts-general', __( 'General Options', 'burcon-plugin' ), [ $this, 'scripts_general_section_callback' ], 'ccp-scripts-general' );

		// Inline scripts.
		add_settings_field( 'ccp_inline_scripts', __( 'Inline Scripts', 'burcon-plugin' ), [ $this, 'ccp_inline_scripts_callback' ], 'ccp-scripts-general', 'ccp-scripts-general', [ esc_html__( 'Add script contents to footer', 'burcon-plugin' ) ] );
		...
		// Inline styles.
		add_settings_field( 'ccp_inline_styles', __( 'Inline Styles', 'burcon-plugin' ), [ $this, 'ccp_inline_styles_callback' ], 'ccp-scripts-general', 'ccp-scripts-general', [ esc_html__( 'Add script-related CSS contents to head', 'burcon-plugin' ) ] );
		...
		// Inline jQuery.
		add_settings_field( 'ccp_inline_jquery', __( 'Inline jQuery', 'burcon-plugin' ), [ $this, 'ccp_inline_jquery_callback' ], 'ccp-scripts-general', 'ccp-scripts-general', [ esc_html__( 'Deregister jQuery and add its contents to footer', 'burcon-plugin' ) ] );
		...
		// Include jQuery Migrate.
		add_settings_field( 'ccp_jquery_migrate', __( 'jQuery Migrate', 'burcon-plugin' ), [ $this, 'ccp_jquery_migrate_callback' ], 'ccp-scripts-general', 'ccp-scripts-general', [ esc_html__( 'Use jQuery Migrate for backwards compatibility', 'burcon-plugin' ) ] );
		...
		// Remove emoji script.
		add_settings_field( 'ccp_remove_emoji_script', __( 'Emoji Script', 'burcon-plugin' ), [ $this, 'remove_emoji_script_callback' ], 'ccp-scripts-general', 'ccp-scripts-general', [ esc_html__( 'Remove emoji script from <head>', 'burcon-plugin' ) ] );
		...
		add_settings_field( 'ccp_remove_script_version', __( 'Script Versions', 'burcon-plugin' ), [ $this, 'remove_script_version_callback' ], 'ccp-scripts-general', 'ccp-scripts-general', [ esc_html__( 'Remove WordPress version from script and stylesheet links in <head>', 'burcon-plugin' ) ] );
		...
		// Minify HTML.
		add_settings_field( 'ccp_html_minify', __( 'Minify HTML', 'burcon-plugin' ), [ $this, 'html_minify_callback' ], 'ccp-scripts-general', 'ccp-scripts-general', [ esc_html__( 'Minify HTML source code to increase load speed', 'burcon-plugin' ) ] );
		 ...
		 */
		add_settings_section( 'ccp-scripts-vendor', __( 'Included Vendor Scripts', 'burcon-plugin' ), [ $this, 'scripts_vendor_section_callback' ], 'ccp-scripts-vendor' );

		// Use Slick.
		add_settings_field( 'ccp_enqueue_slick', __( 'Slick', 'burcon-plugin' ), [ $this, 'enqueue_slick_callback' ], 'ccp-scripts-vendor', 'ccp-scripts-vendor', [ esc_html__( 'Use Slick script and stylesheets', 'burcon-plugin' ) ] );
		...
		// Use Tabslet.
		add_settings_field( 'ccp_enqueue_tabslet', __( 'Tabslet', 'burcon-plugin' ), [ $this, 'enqueue_tabslet_callback' ], 'ccp-scripts-vendor', 'ccp-scripts-vendor', [ esc_html__( 'Use Tabslet script', 'burcon-plugin' ) ] );
		...
		// Use Sticky-kit.
		add_settings_field( 'ccp_enqueue_stickykit', __( 'Sticky-kit', 'burcon-plugin' ), [ $this, 'enqueue_stickykit_callback' ], 'ccp-scripts-vendor', 'ccp-scripts-vendor', [ esc_html__( 'Use Sticky-kit script', 'burcon-plugin' ) ] );
		...
		// Use Tooltipster.
		add_settings_field( 'ccp_enqueue_tooltipster', __( 'Tooltipster', 'burcon-plugin' ), [ $this, 'enqueue_tooltipster_callback' ], 'ccp-scripts-vendor', 'ccp-scripts-vendor', [ esc_html__( 'Use Tooltipster script and stylesheet', 'burcon-plugin' ) ] );
		...
		if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
			...
			add_settings_section( 'ccp-registered-fields-activate', __( 'Registered Fields Activation', 'burcon-plugin' ), [ $this, 'registered_fields_activate' ], 'ccp-registered-fields-activate' );

			add_settings_field( 'ccp_acf_activate_settings_page', __( 'Site Settings Page', 'burcon-plugin' ), [ $this, 'registered_fields_page_callback' ], 'ccp-registered-fields-activate', 'ccp-registered-fields-activate', [ __( 'Deactive the field group for the "Site Settings" options page.', 'burcon-plugin' ) ] );
	...
	public function enqueue_slick_callback( $args ) {
		...
		$html .= sprintf(
			...
			esc_attr( __( 'Learn more about Slick', 'burcon-plugin' ) )
		);
		$html .= '</p>';
	...
	public function enqueue_tabslet_callback( $args ) {
		...
		$html .= sprintf(
			...
			esc_attr( __( 'Learn more about Tabslet', 'burcon-plugin' ) )
		);
		$html .= '</p>';
	...
	public function enqueue_stickykit_callback( $args ) {
		...
		$html .= sprintf(
			...
			esc_attr( __( 'Learn more about Sticky-kit', 'burcon-plugin' ) )
		);
		$html .= '</p>';
	...
	public function enqueue_tooltipster_callback( $args ) {
		...
		$html .= sprintf(
			...
			esc_attr( __( 'Learn more about Tooltipster', 'burcon-plugin' ) )
		);
		$html .= '</p>';
	...
	public function registered_fields_activate() {
		...
		if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
			...
			echo sprintf( '<p>%1s</p>', esc_html( 'The Burcon Outfitters plugin registers custom fields for Advanced Custom Fields Pro that can be imported for editing. These built-in field goups must be deactivated for the imported field groups to take effect.', 'burcon-plugin' ) );
