...
class Settings_Fields_Site_Dashboard {
	...
	private function dependencies() {
		...
		require BURCON_PATH . 'admin/partials/field-callbacks/class-dashboard-callbacks.php';
	...
	public function settings() {
		...
		add_settings_field(
			...
			__( 'Hide Try Gutenberg', 'burcon-plugin' ),
			[ Callbacks::instance(), 'hide_try_gutenberg' ],
			'ccp-site-dashboard',
			'ccp-site-dashboard',
			[ esc_html__( 'Hide the "Try Gutenberg" panel on the Dashboard', 'burcon-plugin' ) ]
		);
