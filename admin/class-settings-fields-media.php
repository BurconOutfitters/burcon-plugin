...
class Settings_Fields_Media {
    ...
    public function svg_notice() {
        ...
        $html = sprintf( '<p>%1s</p>', esc_html__( 'Use SVG images with caution! Only add support if you trust or examine each SVG file that you upload.', 'burcon-plugin' ) );
    ...
    public function fancybox_description() {
        ...
        $html = sprintf( '<p>%1s <a href="%2s" target="_blank">%3s</a></p>', esc_html__( 'Documentation on the Fancybox website:', 'burcon-plugin' ), esc_url( $url ), $url );
