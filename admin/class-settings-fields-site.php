...
class Settings_Fields_Site {
	...
	public function settings() {
		...
		add_settings_field(
			'burcon_hide_wp_news',
			__( 'Hide WordPress News', 'burcon-plugin' ),
			[ $this, 'burcon_hide_wp_news_callback' ],
			'burcon-site-dashboard',
			'burcon-site-dashboard',
			[ esc_html__( 'Hide the WordPress News widget on the Dashboard', 'burcon-plugin' ) ]
		);
		...
		add_settings_field(
			...
			__( 'Hide Quick Draft', 'burcon-plugin' ),
			[ $this, 'burcon_hide_quickpress_callback' ],
			'burcon-site-dashboard',
			'burcon-site-dashboard',
			[ esc_html__( 'Hide the Quick Draft widget on the Dashboard', 'burcon-plugin' ) ]
		);
		...
		add_settings_field(
			...
			__( 'Hide At a Glance', 'burcon-plugin' ),
			[ $this, 'burcon_hide_at_glance_callback' ],
			'burcon-site-dashboard',
			'burcon-site-dashboard',
			[ esc_html__( 'Hide the At a Glance widget on the Dashboard', 'burcon-plugin' ) ]
		);
		...
		add_settings_field(
			...
			__( 'Hide Activity', 'burcon-plugin' ),
			[ $this, 'burcon_hide_activity_callback' ],
			'burcon-site-dashboard',
			'burcon-site-dashboard',
			[ esc_html__( 'Hide the Activity widget on the Dashboard', 'burcon-plugin' ) ]
		);
		...
		add_settings_field(
			...
			'burcon-site-admin-menu',
			'burcon-site-admin-menu',
			[ esc_html__( 'Make this settings page a top-level link.', 'burcon-plugin' ) ]
		);
		...
		add_settings_section(
			...
			__( 'Meta & SEO Settings', 'burcon-plugin' ),
			[],
			'burcon-site-meta-seo'
		);
		...
		add_settings_field(
			'burcon_disable_meta',
			__( 'Meta Tags', 'burcon-plugin' ),
			[ $this, 'burcon_disable_meta_callback' ],
			'burcon-site-meta-seo',
			'burcon-site-meta-seo',
			[ esc_html__( 'Disable if your theme includes SEO meta tags or if you plan on using an SEO plugin.', 'burcon-plugin' ) ]
		);
	...
	public function burcon_site_settings_link_label_callback( $args ) {
		...
		$html = '<p><input type="text" size="50" id="burcon_site_settings_link_label" name="burcon_site_settings_link_label" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'Site Settings', 'burcon-plugin' ) ) . '" /><br />';
	...
	public function burcon_site_settings_link_icon_callback( $args ) {
		...
		$html = '<p><input type="text" size="50" id="burcon_site_settings_link_icon" name="burcon_site_settings_link_icon" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'dashicons-admin-settings', 'burcon-plugin' ) ) . '" /><br />';
	...
	public function burcon_site_plugin_link_label_callback( $args ) {
		...
		$html = '<p><input type="text" size="50" id="burcon_site_plugin_link_label" name="burcon_site_plugin_link_label" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'Site Plugin', 'burcon-plugin' ) ) . '" /><br />';
	...
	public function burcon_site_plugin_link_icon_callback( $args ) {
		...
		$html = '<p><input type="text" size="50" id="burcon_site_settings_link_icon" name="burcon_site_plugin_link_icon" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'dashicons-welcome-learn-more', 'burcon-plugin' ) ) . '" /><br />';
	...
	public function burcon_footer_credit_callback( $args ) {
		...
		$html = '<p><input type="text" size="50" id="burcon_footer_credit" name="burcon_footer_credit" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'Your name/agency', 'burcon-plugin' ) ) . '" /><br />';
