...
class Settings_Fields_Users {
	...
	private function dependencies() {
		...
		require BURCON_PATH . 'admin/partials/field-callbacks/class-users-callbacks.php';
	...
	public function settings() {
        ...
        add_settings_section(
            'ccp-site-users',
            __( 'User Settings', 'burcon-plugin' ),
            [],
            'ccp-site-users'
        );
		...
		add_settings_field(
			'ccp_block_gravatar',
			__( 'Block Gravatars', 'burcon-plugin' ),
			[ Callbacks::instance(), 'block_gravatar' ],
			'ccp-site-users',
			'ccp-site-users',
			[ esc_html__( 'Prevent avatar requests from Gravatar.com', 'burcon-plugin' ) ]
		);
