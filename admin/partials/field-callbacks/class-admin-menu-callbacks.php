...
class Admin_Menu_Callbacks {
	...
	public function site_settings_link_label( $args ) {
		...
		$html = '<p><input type="text" size="50" id="ccp_site_settings_link_label" name="ccp_site_settings_link_label" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'Site Settings', 'burcon-plugin' ) ) . '" /><br />';
	...
	public function site_settings_link_icon( $args ) {
		...
		$html = '<p><input type="text" size="50" id="ccp_site_settings_link_icon" name="ccp_site_settings_link_icon" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'dashicons-admin-settings', 'burcon-plugin' ) ) . '" /><br />';
	...
	public function site_plugin_link_label( $args ) {
		...
		$html = '<p><input type="text" size="50" id="ccp_site_plugin_link_label" name="ccp_site_plugin_link_label" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'Site Plugin', 'burcon-plugin' ) ) . '" /><br />';
	...
	public function site_plugin_link_icon( $args ) {
		...
		$html = '<p><input type="text" size="50" id="ccp_site_settings_link_icon" name="ccp_site_plugin_link_icon" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'dashicons-welcome-learn-more', 'burcon-plugin' ) ) . '" /><br />';
