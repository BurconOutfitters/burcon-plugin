...
class Admin_Pages_Callbacks {
	...
	public function footer_credit( $args ) {
		...
		$html = '<p><input type="text" size="50" id="ccp_footer_credit" name="ccp_footer_credit" value="' . esc_attr( $option ) . '" placeholder="' . esc_attr( __( 'Your name/agency', 'burcon-plugin' ) ) . '" /><br />';
