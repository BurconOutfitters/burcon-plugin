...
namespace Burcon_Plugin\Admin\Partials\Help;
...
<?php echo sprintf( '<li><strong>%1s:</strong> %2s</li>', esc_html__( 'Classes', 'burcon-plugin' ), esc_html__( 'Classes are prefixed with the plugin name. Replace "Controlled_Chaos".', 'burcon-plugin' ) ); ?>
...
<?php echo sprintf( '<li><strong>%1s:</strong> %2s</li>', esc_html__( 'Version', 'burcon-plugin' ), esc_html__( 'The plugin version is all caps and is prexixed with an abbreviation for the plugin name. Replace "CCP".', 'burcon-plugin' ) ); ?>
...
<?php echo sprintf( '<li><strong>%1s:</strong> %2s</li>', esc_html__( 'Plugin Name', 'burcon-plugin' ), esc_html__( 'The plugin name is used in various places. Replace "Controlled Chaos".', 'burcon-plugin' ) ); ?>
</ol>