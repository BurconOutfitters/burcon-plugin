...
$tabs = [
    ...
    sprintf(
        ...
        esc_html__( 'Dashboard', 'burcon-plugin' )
    ),
    ...
    sprintf(
        ...
        esc_html__( 'Admin Menu', 'burcon-plugin' )
    ),
    ...
    sprintf(
        ...
        esc_html__( 'Admin Pages', 'burcon-plugin' )
    ),
    ...
    sprintf(
        ...
        esc_html__( 'Site Users', 'burcon-plugin' )
    ),
    ...
    sprintf(
        ...
        esc_html__( 'Meta/SEO', 'burcon-plugin' )
    )
 ...
 */
if ( 'dashboard' == $active_tab  ) {
    $save = __( 'Save Dashboard', 'burcon-plugin' );
} elseif ( 'admin-menu' == $active_tab ) {
    $save = __( 'Save Menu', 'burcon-plugin' );
} elseif ( 'admin-pages' == $active_tab ) {
    $save = __( 'Save Pages', 'burcon-plugin' );
} elseif ( 'users' == $active_tab ) {
    $save = __( 'Save Users', 'burcon-plugin' );
} elseif ( 'meta-seo' == $active_tab ) {
    $save = __( 'Save Meta', 'burcon-plugin' );
} else {
    $save = __( 'Save Settings', 'burcon-plugin' );
}
...
<div class="wrap">
	<?php echo sprintf(
        ...
        get_bloginfo( 'name' ),
        esc_html__( 'Settings', 'burcon-plugin' )
    ); ?>
    <p class="description"><?php esc_html_e( 'Customize the way WordPress is used.', 'burcon-plugin' ); ?></p>
