...
$tabs = [
    ...
    sprintf(
        ...
        esc_html__( 'General', 'burcon-plugin' )
    )
 ...
 */
if ( 'general' == $active_tab  ) {
    $save = __( 'Save General', 'burcon-plugin' );
} else {
...
<div id="setting-error-settings_updated" class="notice notice-success is-dismissible">
	<p><strong><?php _e( 'Settings saved.', 'burcon-plugin' ); ?></strong></p>
</div>
<?php } ?>
<div class="wrap">
	<?php echo sprintf( '<h1 class="wp-heading-inline">%1s %2s</h1>', get_bloginfo( 'name' ), esc_html__( 'Development', 'burcon-plugin' ) ); ?>
	<p class="description"><?php _e( 'A few tools that come in handy during the development of your website.', 'burcon-plugin' ); ?></p>
