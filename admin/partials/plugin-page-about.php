...
$tabs = [
    ...
    sprintf(
        ...
        '#intro',
        esc_html__( 'Introduction', 'burcon-plugin' )
	),
    ...
    sprintf(
		...
		'#settings',
		esc_attr( $settings ),
        esc_html__( 'Site Settings', 'burcon-plugin' )
	),
    ...
    sprintf(
        ...
        '#scripts',
        esc_html__( 'Script Options', 'burcon-plugin' )
	),
    ...
    sprintf(
        ...
        '#media',
        esc_html__( 'Media Options', 'burcon-plugin' )
	),
    ...
    sprintf(
        '<li><a href="%1s"><span class="dashicons dashicons-welcome-learn-more"></span> %2s</a></li>',
        '#tools',
        esc_html__( 'Development Tools', 'burcon-plugin' )
    ),
...
<div class="wrap">
	<!-- Page heading -->
	<?php echo sprintf( '<h1 class="wp-heading-inline">%1s %2s</h1>', get_bloginfo( 'name' ), esc_html__( 'Plugin', 'burcon-plugin' ) ); ?>
	<!-- Page description -->
    <p class="description"><?php esc_html_e( 'A feature-packed WordPress starter plugin for building custom-tailored websites.', 'burcon-plugin' ); ?></p>
	<!-- Ornamental divider -->
