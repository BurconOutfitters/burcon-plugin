...
class Settings_Fields_Site_Meta_SEO {
	...
	private function dependencies() {
		...
		require BURCON_PATH . 'admin/partials/field-callbacks/class-meta-seo-callbacks.php';
	...
	public function settings() {
		...
		add_settings_field(
			'schema_org_type',
			__( 'Organization Type', 'burcon-plugin' ),
			[ Partials\Field_Callbacks\Meta_SEO_Callbacks::instance(), 'schema_org_type' ],
			'ccp-site-meta-seo',
			'ccp-site-meta-seo',
			[ esc_html__( 'Select a category that generally applies to this website.', 'burcon-plugin' ) ]
		);
